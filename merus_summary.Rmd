...
The general guidline for a linear regression with a significance level of .05 and a power of 85% without prior knowledge would suggest a sample size of 449 (see results below). Increasing the power to 95%, under the same conditions would yield a same size of 650.

\newline
However, using the knowledge of the existing relationship above will decrease the sample size needed but reducing the effect size (because you already know there is a strong linear relationship). This suggests a sample size of 150 (alpha = 0.05, power = 85%) and a sample size of 217 (alpha = 0.05, power = 95%). 
...
### Between mean of legal and sublegal?

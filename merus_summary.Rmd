...
Caveat: In this exploratory analysis we are using Bristol Bay data but the legal size for Southeast Alaska. One would expect the data maybe different for Southeast Alaska. 
...
Vertical and horisontal black line represents legal size in SE Alaska. Vertical and horizontal dashed gray line represents legal size in Bristol Bay (where data are taken from). 
